...
<body>
    ...
    <div class="container-fluid vh-100">
        ...
        <div class="row h-100">
            ...
            {{-- LEFT PANEL --}}
            <div class="col-lg-8 d-none d-lg-flex auth-brand align-items-center ">
            ...
            {{-- RIGHT PANEL --}}
            <div class="col-lg-4 auth-form d-flex align-items-center">
    ...
    {{-- jQuery (Required for Toastr.js alerts) --}}
